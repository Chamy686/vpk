...
{
	AddMenuFooterOption( file.menu, LEFT, BUTTON_START, false, "#CONTROL_SHOW_SCOREBOARD_GAMEPAD", "#CONTROL_SHOW_SCOREBOARD", ControlSpawnMenu_OpenScoreboard, CanOpenScoreboard )
	AddMenuFooterOption( file.menu, LEFT, BUTTON_START, false, "#CONTROL_HIDE_SCOREBOARD_GAMEPAD", "#CONTROL_HIDE_SCOREBOARD", ControlSpawnMenu_CloseScoreboard, CanCloseScoreboard )
	AddMenuFooterOption( file.menu, RIGHT, BUTTON_DPAD_UP, false, "#MODE_DETAILS_GAMEPAD", "#MODE_DETAILS", ControlSpawnMenu_OpenGameModeDetails, GameModeHasRules )
