...
void function MiscCustomizeMenu_Update( var menu )
{
	...
	if ( GetActiveMenu() == menu )
	{
		...
		{
			TabDef tabdef = AddTab( menu, file.tabBodyPanelList[0], Localize( "#TAB_CUSTOMIZE_LOADSCREEN" ).toupper(), false, tabBarLeftOffsetFracIfVisible )
			tabdef.width = 280
			tabdef.isBannerLogoSmall = true
		}
		{
			TabDef tabdef = AddTab( menu, file.tabBodyPanelList[1], Localize( "#TAB_CUSTOMIZE_MUSIC_PACK" ).toupper(), false, tabBarLeftOffsetFracIfVisible )
			tabdef.width = 260
			tabdef.isBannerLogoSmall = true
		}
		{
			TabDef tabdef = AddTab( menu, file.tabBodyPanelList[2], Localize( "#TAB_CUSTOMIZE_SKYDIVE_TRAIL" ).toupper(), false, tabBarLeftOffsetFracIfVisible )
			tabdef.width = 270
			tabdef.isBannerLogoSmall = true
		}
