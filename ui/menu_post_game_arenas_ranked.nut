...
#if DEV
	AddMenuThinkFunc( file.menu, PostGameArenasRankedMenuAutomationThink )
#endif       
}

#if DEV
void function PostGameArenasRankedMenuAutomationThink( var menu )
{
	if (AutomateUi())
	{
		printt("PostGameArenasRankedMenuAutomationThink OnContinue_Activate()")
