...
void function InitCustomMatchLobbyPanel( var panel )
{
	...
	AddPanelFooterOption( panel, LEFT, BUTTON_STICK_LEFT, true, "#DATACENTER_DOWNLOADING", "#DATACENTER_DOWNLOADING", CustomMatchOpenDataCenterDialog, CustomMatchDatacenter_CanClick, CustomMatchUpdateDataCenterFooter )
...
void function Callback_OnChatPermissionChanged( string _, string value )
{
	...
	UIPos inputPos = REPLACEHud_GetPos( file.chatInputLine )
	UISize inputSize = REPLACEHud_GetSize( file.chatInputLine )
